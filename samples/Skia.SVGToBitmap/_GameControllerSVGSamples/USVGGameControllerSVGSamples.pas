(* C2PP
  ...
  ***************************************************************************
  ...
  Signature : 8c1ff332e7b6522f0ccc0ba29d26ca9a22d5b82b
  ***************************************************************************
*)

unit USVGGameControllerSVGSamples;
...
// Generation date : 01/08/2024 10:28:48
//
...
{ TSVGGameControllerSVGSamples }

class constructor TSVGGameControllerSVGSamples.Create;
begin
  inherited;
  FTag := 0;
  FTagBool := false;
...
class procedure TSVGGameControllerSVGSamples.SetTag(const Value: integer);
begin
  FTag := Value;
end;

class procedure TSVGGameControllerSVGSamples.SetTagBool(const Value: Boolean);
begin
  FTagBool := Value;
end;

class procedure TSVGGameControllerSVGSamples.SetTagFloat(const Value: Single);
begin
  FTagFloat := Value;
end;

class procedure TSVGGameControllerSVGSamples.SetTagObject(const Value: TObject);
begin
  FTagObject := Value;
end;

class procedure TSVGGameControllerSVGSamples.SetTagString(const Value: string);
begin
  FTagString := Value;
end;
